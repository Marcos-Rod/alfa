<div class="hd-contactos d-flex align-items-center text-white fs-6">
    <div class="container">
        <div class="row">
...
<div class="banner position-relative">
    <div class="menu-hd position-absolute w-100 py-3">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 text-lg-end text-center order-2 order-lg-3 mt-3 mt-lg-0 align-self-center">
                    <p class="mb-0">
